...
# Modified by Jordi Boehme Lopez for ASIHTTPRequest.framework

set -e

# Define these to suit your nefarious purposes
                 FRAMEWORK_NAME=ASIHTTPRequest
                       LIB_NAME=libASIHTTPRequest
              FRAMEWORK_VERSION=A
                     BUILD_TYPE=Release
...
cp -v build/$BUILD_TYPE-iphoneos/include/*.h $FRAMEWORK_DIR/Headers/
